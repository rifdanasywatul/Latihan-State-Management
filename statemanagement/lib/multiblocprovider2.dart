...
//screen kedua
// Kelas ScreenDetil adalah halaman untuk menampilkan detail jenis pinjaman.
class ScreenDetil extends StatelessWidget {
  const ScreenDetil({Key? key}) : super(key: key);//constructor
...
// Kelas DetilJenisPinjamanCubit adalah sebuah Cubit yang mengelola keadaan DetilJenisPinjamanModel.
class DetilJenisPinjamanCubit extends Cubit<DetilJenisPinjamanModel> {
  ...
  DetilJenisPinjamanCubit()
      : super(DetilJenisPinjamanModel(
            bunga: '', isSyariah: '', id: '', nama: ''));//constructor
  ...
  // Metode untuk mengambil data detail jenis pinjaman dari API berdasarkan ID.
...
class JenisPinjaman {
  ...
  String id;
  String nama;
  JenisPinjaman({required this.id, required this.nama});//constructor
}

// Kelas JenisPinjamanModel adalah model untuk jenis pinjaman, termasuk daftar jenis pinjaman dan pilihan jenis pinjaman yang dipilih.
...
// Kelas JenisPinjamanCubit adalah sebuah Cubit yang mengelola keadaan JenisPinjamanModel.
class JenisPinjamanCubit extends Cubit<JenisPinjamanModel> {
  ...
  void setFromJson(Map<String, dynamic> json, String jenis) {
   ...
   // Metode untuk mengambil data jenis pinjaman dari API berdasarkan jenis.
